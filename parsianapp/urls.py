...
urlpatterns =[
    ...
    path('manage/input/',views.input,name='input'),
    path('manage/input/submit_person/',views.submit_person,name='submit_person'),
    path('login/',views.login,name='login'),
    path('manage/input/summary_of_results/add_summary/',views.addperson,name='addsummary'),
    path('manage/input/submit_company/',views.company,name='submit_company'),
    path('manage/output/',views.output,name='output'),
