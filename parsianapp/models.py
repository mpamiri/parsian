...
class Personal_Species_Model(models.Model):
    ...
    date_year=models.IntegerField(default='', null=True, blank=True)
    date_month=models.IntegerField(default='', null=True, blank=True)
    date_day=models.IntegerField(default='', null=True, blank=True)
    profil_number=models.IntegerField(default='', null=True, blank=True)
    employment_number=models.IntegerField(default='', null=True, blank=True)
    name = models.CharField(max_length=20, null=True, blank=True,unique=True)
    ...
    children = models.IntegerField(default='', null=True, blank=True)
    age = models.IntegerField(default='', null=True, blank=True,validators=[MinValueValidator(1300),MaxValueValidator(1400)])
    personal_code = models.IntegerField(default='', null=True, blank=True)
...
class Examinations_Model(models.Model):
    ...
    date_month=models.IntegerField(default='', null=True, blank=True)
    date_day=models.IntegerField(default='', null=True, blank=True)
    weight = models.IntegerField(default='', null=True, blank=True,validators=[MinValueValidator(20),MaxValueValidator(200)])
    blood_pressure = models.IntegerField(default='', null=True, blank=True,validators=[MinValueValidator(5),MaxValueValidator(20)])
    length = models.IntegerField(default='', null=True, blank=True,validators=[MinValueValidator(100),MaxValueValidator(300)])
    pulse = models.IntegerField(default='', null=True, blank=True,validators=[MinValueValidator(0)])
...
class Experiments_Model(models.Model):
    ...
    date_month=models.IntegerField(default='', null=True, blank=True)
    date_day=models.IntegerField(default='', null=True, blank=True)
    cbc_wbc=models.IntegerField(default='', null=True, blank=True)
    cbc_rbc=models.IntegerField(default='', null=True, blank=True)
    cbc_hb=models.IntegerField(default='', null=True, blank=True)
    cbc_htc=models.IntegerField(default='', null=True, blank=True)
    cbc_plt=models.IntegerField(default='', null=True, blank=True)
    ua_prot=models.IntegerField(default='', null=True, blank=True)
    ua_glu=models.IntegerField(default='', null=True, blank=True)
    ua_rbc=models.IntegerField(default='', null=True, blank=True)
    ua_wbc=models.IntegerField(default='', null=True, blank=True)
    ua_bact=models.IntegerField(default='', null=True, blank=True)
    fbs=models.IntegerField(default='', null=True, blank=True)
    chol=models.IntegerField(default='', null=True, blank=True)
    ldl=models.IntegerField(default='', null=True, blank=True)
    hdl=models.IntegerField(default='', null=True, blank=True)
    tg=models.IntegerField(default='', null=True, blank=True)
    bun=models.IntegerField(default='', null=True, blank=True)
    cr=models.IntegerField(default='', null=True, blank=True)
    alt=models.IntegerField(default='', null=True, blank=True)
    ast=models.IntegerField(default='', null=True, blank=True)
    alk=models.IntegerField(default='', null=True, blank=True)
    hbs=models.IntegerField(default='', null=True, blank=True)
    se=models.IntegerField(default='', null=True, blank=True)
    ppd=models.IntegerField(default='', null=True, blank=True)
...
class Para_Clinic_Model(models.Model):
    ...
    opto_date_year=models.IntegerField(default='', null=True, blank=True)
    opto_hedat_r_ba=models.IntegerField(default='', null=True, blank=True)
    opto_hedat_r_bi=models.IntegerField(default='', null=True, blank=True)
    opto_hedat_l_ba=models.IntegerField(default='', null=True, blank=True)
    opto_hedat_l_bi=models.IntegerField(default='', null=True, blank=True)
    opto_rangi_hedat_r_ba=models.IntegerField(default='', null=True, blank=True)
    opto_rangi_hedat_r_bi=models.IntegerField(default='', null=True, blank=True)
    opto_rangi_hedat_l_ba=models.IntegerField(default='', null=True, blank=True)
    opto_rangi_hedat_l_bi=models.IntegerField(default='', null=True, blank=True)
    opto_meidan_hedat_r_ba=models.IntegerField(default='', null=True, blank=True)
    opto_meidan_hedat_r_bi=models.IntegerField(default='', null=True, blank=True)
    opto_meidan_hedat_l_ba=models.IntegerField(default='', null=True, blank=True)
    opto_meidan_hedat_l_bi=models.IntegerField(default='', null=True, blank=True)
    opto_omgh = models.IntegerField(default='', null=True, blank=True)

    audio_date_year=models.IntegerField(default='', null=True, blank=True)
    audio_date_month=models.IntegerField(default='', null=True, blank=True)
    audio_date_day=models.IntegerField(default='', null=True, blank=True)
    oudio_tafsir = models.CharField(max_length=50, null=True, blank=True)
    audio_r_eight_ac = models.IntegerField(default='', null=True, blank=True)
    audio_r_eight_bc = models.IntegerField(default='', null=True, blank=True)
    audio_r_six_ac = models.IntegerField(default='', null=True, blank=True)
    audio_r_six_bc = models.IntegerField(default='', null=True, blank=True)
    audio_r_four_ac = models.IntegerField(default='', null=True, blank=True)
    audio_r_four_bc = models.IntegerField(default='', null=True, blank=True)
    audio_r_two_ac = models.IntegerField(default='', null=True, blank=True)
    audio_r_two_bc = models.IntegerField(default='', null=True, blank=True)
    audio_r_one_ac = models.IntegerField(default='', null=True, blank=True)
    audio_r_one_bc = models.IntegerField(default='', null=True, blank=True)
    audio_r_five_ac = models.IntegerField(default='', null=True, blank=True)
    audio_r_five_bc = models.IntegerField(default='', null=True, blank=True)
    audio_l_eight_ac = models.IntegerField(default='', null=True, blank=True)
    audio_l_eight_bc = models.IntegerField(default='', null=True, blank=True)
    audio_l_six_ac = models.IntegerField(default='', null=True, blank=True)
    audio_l_six_bc = models.IntegerField(default='', null=True, blank=True)
    audio_l_four_ac = models.IntegerField(default='', null=True, blank=True)
    audio_l_four_bc = models.IntegerField(default='', null=True, blank=True)
    audio_l_two_ac = models.IntegerField(default='', null=True, blank=True)
    audio_l_two_bc = models.IntegerField(default='', null=True, blank=True)
    audio_l_one_ac = models.IntegerField(default='', null=True, blank=True)
    audio_l_one_bc = models.IntegerField(default='', null=True, blank=True)
    audio_l_five_ac = models.IntegerField(default='', null=True, blank=True)
    audio_l_five_bc = models.IntegerField(default='', null=True, blank=True)

    espiro_date_year=models.IntegerField(default='', null=True, blank=True)
    espiro_date_month=models.IntegerField(default='', null=True, blank=True)
    espiro_date_day=models.IntegerField(default='', null=True, blank=True)
    ...
    other_cxr_year=models.IntegerField(default='', null=True, blank=True)
    other_cxr_month=models.IntegerField(default='', null=True, blank=True)
    other_cxr_day=models.IntegerField(default='', null=True, blank=True)
    other_ecg = models.CharField(max_length=50, null=True, blank=True)
    other_ecg_year=models.IntegerField(default='', null=True, blank=True)
    other_ecg_month=models.IntegerField(default='', null=True, blank=True)
    other_ecg_day=models.IntegerField(default='', null=True, blank=True)
...
class Consulting_Model(models.Model):
    ...
    first_year=models.IntegerField(default='', null=True, blank=True)
    first_month=models.IntegerField(default='', null=True, blank=True)
    first_day=models.IntegerField(default='', null=True, blank=True)
    first_reason = models.CharField(max_length=50, null=True, blank=True)
    first_type = models.CharField(max_length=50, null=True, blank=True)
    first_result = models.CharField(max_length=50, null=True, blank=True)
    second_year=models.IntegerField(default='', null=True, blank=True)
    second_month=models.IntegerField(default='', null=True, blank=True)
    second_day=models.IntegerField(default='', null=True, blank=True)
