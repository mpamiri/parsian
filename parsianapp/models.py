...
class Examinations_Model(models.Model):
    ...
    date_month=models.IntegerField(null=True, blank=True)
    date_day=models.IntegerField(null=True, blank=True)
    weight = models.IntegerField(null=True, blank=True,validators=[MinValueValidator(20),MaxValueValidator(200)])
    blood_pressure = models.IntegerField(null=True, blank=True,validators=[MinValueValidator(5),MaxValueValidator(20)])
    length = models.IntegerField(null=True, blank=True,validators=[MinValueValidator(100),MaxValueValidator(300)])
    pulse = models.IntegerField(null=True, blank=True,validators=[MinValueValidator(0)])
