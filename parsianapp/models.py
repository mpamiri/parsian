...
class Para_Clinic_Model(models.Model):
    ...
    audio_r_sds = models.CharField(max_length=50, null=True, blank=True)
    audio_r_srt = models.CharField(max_length=50, null=True, blank=True)
    audio_r_eight_ac = models.CharField(max_length=50, null=True, blank=True)
    audio_r_eight_bc = models.CharField(max_length=50, null=True, blank=True)
    audio_r_six_ac = models.CharField(max_length=50, null=True, blank=True)
    audio_r_six_bc = models.CharField(max_length=50, null=True, blank=True)
    audio_r_four_ac = models.CharField(max_length=50, null=True, blank=True)
    audio_r_four_bc = models.CharField(max_length=50, null=True, blank=True)
    audio_r_two_ac = models.CharField(max_length=50, null=True, blank=True)
    audio_r_two_bc = models.CharField(max_length=50, null=True, blank=True)
    audio_r_one_ac = models.CharField(max_length=50, null=True, blank=True)
    audio_r_one_bc = models.CharField(max_length=50, null=True, blank=True)
    audio_r_five_ac = models.CharField(max_length=50, null=True, blank=True)
    audio_r_five_bc = models.CharField(max_length=50, null=True, blank=True)
    audio_l_sds = models.CharField(max_length=50, null=True, blank=True)
    audio_l_srt = models.CharField(max_length=50, null=True, blank=True)
    audio_l_eight_ac = models.CharField(max_length=50, null=True, blank=True)
    audio_l_eight_bc = models.CharField(max_length=50, null=True, blank=True)
    audio_l_six_ac = models.CharField(max_length=50, null=True, blank=True)
    audio_l_six_bc = models.CharField(max_length=50, null=True, blank=True)
    audio_l_four_ac = models.CharField(max_length=50, null=True, blank=True)
    audio_l_four_bc = models.CharField(max_length=50, null=True, blank=True)
    audio_l_two_ac = models.CharField(max_length=50, null=True, blank=True)
    audio_l_two_bc = models.CharField(max_length=50, null=True, blank=True)
    audio_l_one_ac = models.CharField(max_length=50, null=True, blank=True)
    audio_l_one_bc = models.CharField(max_length=50, null=True, blank=True)
    audio_l_five_ac = models.CharField(max_length=50, null=True, blank=True)
    audio_l_five_bc = models.CharField(max_length=50, null=True, blank=True)
