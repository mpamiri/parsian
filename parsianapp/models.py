...
class summary_of_results(models.Model):
    ...
    breathing_CHOICES = [('null', ''), ('نرمال', 'نرمال'), ('تحدیدی', 'تحدیدی'), ('انسدادی', 'انسدادی'),
                         ('نیاز به تکرار', 'نیاز به تکرار'), ('namaie_toaman', 'نمای توامان تحدیدی وانسدادی'),
                         ('ندارد', 'ندارد')]
    breathing_test = models.CharField(choices=breathing_CHOICES, max_length=300, default='', null=True, blank=True)
    left_ear_CHOICES = [('null', ''), ('نرمال', 'نرمال'), ('کاهش شنوایی هدایتی', 'کاهش شنوایی هدایتی'),
                        ('کاهش شنوایی حسی عصبی', 'کاهش شنوایی حسی عصبی'),
                        ('کاهش شنوایی ناشی از صدا', 'کاهش شنوایی ناشی از صدا'),
                        ('توامان هدایتی و حسی عصبی', 'توامان هدایتی و حسی عصبی'), ('ندارد', 'ندارد')]
    left_ear_hearing = models.CharField(choices=left_ear_CHOICES, max_length=300, default='', null=True, blank=True)
    right_ear_CHOICES = [('null', ''), ('نرمال', 'نرمال'), ('کاهش شنوایی هدایتی', 'کاهش شنوایی هدایتی'),
                         ('کاهش شنوایی حسی عصبی', 'کاهش شنوایی حسی عصبی'),
                         ('کاهش شنوایی ناشی از صدا', 'کاهش شنوایی ناشی از صدا'),
                         ('توامان هدایتی و حسی عصبی', 'توامان هدایتی و حسی عصبی'), ('ندارد', 'ندارد')]
    ...
    color_CHOICES = [('null', ''), ('نرمال', 'نرمال'), ('غیر نرمال', 'غیر نرمال'), ('تشخیص رنگ قرمز', 'تشخیص رنگ قرمز'),
                     ('ندارد', 'ندارد')]
    ...
    heart_CHOICES = [('null', ''), ('نرمال', 'نرمال'), ('تغییرات غیر اختصاصی', 'تغییرات غیر اختصاصی'),
                     ('نیاز به تکرار', 'نیاز به تکرار'), ('غیر نرمال', 'غیر نرمال'), ('ندارد', 'ندارد')]
    ...
    refer_CHOICES = [('null', ''), ('ندارد', 'ندارد'), ('قلب و عروق', 'قلب و عروق'), ('داخلی', 'داخلی'), ('ریه', 'ریه'),
                     ('غدد', 'غدد'), ('سایر', 'سایر')]
    refer_to_specialist = models.CharField(choices=refer_CHOICES, max_length=300, default='', null=True, blank=True)
    final_CHOICES = [('null', ''), ('بلامانع', 'بلامانع'), ('تغییر شغل', 'تغییر شغل'), ('مشروط', 'مشروط'),
                     ('کمیسیون', 'کمیسیون')]
    ...
    occupational_CHOICES = [('null', ''), ('درحال پیگیری', 'درحال پیگیری'), ('انجام شده', 'انجام شده'),
